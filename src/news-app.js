  ...
  static get template() {
    ...
    <style>
      ...
      :host {
        ...
        --app-nav-background-color: #073434;
    ...
    <news-analytics key="UA-25275363-1"></news-analytics>
    ...
    <footer>
    <a href="https://www.auburnalabama.org/">City of Auburn, Alabama</a> published by Public Affairs out of the <a href="https://www.auburnalabama.org/office-of-the-city-manager/">Office of the City Manager</a>.<br>Historical <a href="https://www.auburnalabama.org/news/archive">archive</a> available.
    </footer>
`;
  }
  ...
  _routePageChanged(page, isAttached) {
    ...
    if (!page) {
      ...
      this.set('route.path', 'list/Top%20Stories');
      return;
    }
    this.page = page;
